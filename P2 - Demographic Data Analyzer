...
def calculate_demographic_data(print_data=True):
        # Read data from file
    df = pd.read_csv('adult.data.csv',header=0,sep=",")
    ...
    highest_earning_country_percentage = (country_stats / df['native-country'].value_counts())[highest_earning_country] * 100
...
test = calculate_demographic_data(print_data=True)
